...
<div v-cloak class="stm_metaboxes_grid <?php echo esc_attr('sections_count_' . count($sections)); ?>" <?php echo esc_html($vue_id . ' ' . $source_id); ?>>
	...
	<div class="stm_metaboxes_grid__inner" v-if="data !== ''">
		...
		<div class="container">
					...
					foreach ($sections as $section_name => $section) :
						...
						<div class="wpcfto-nav <?php echo esc_attr(implode(' ', $section_classes)); ?>">
							...
							<div class="wpcfto-nav-title"
								...
								<?php echo esc_html(sanitize_text_field($section['name'])); ?>
							</div>
							...
							<?php if (!empty($submenus)) : ?>
								<div class="wpcfto-submenus">
									...
									foreach ($submenus as $key => $_submenu) :
										...
										?>
										<div data-submenu="<?php echo esc_attr($section_name . '_' . sanitize_title($_submenu)); ?>"
											class="<?php echo esc_attr(implode(' ', $submenu_classes)); ?>"
											@click="changeSubMenu('<?php echo esc_attr($section_name . '_' . sanitize_title($_submenu)); ?>')">
			...
			foreach ($sections as $section_name => $section) :
				...
				?>
				<div id="<?php echo esc_attr($section_name); ?>" class="wpcfto-tab <?php echo esc_attr(implode(' ', $section_classes)); ?>">
						...
						<div class="row">
							...
							<div class="column">
								...
								foreach ($section['fields'] as $field_name => $field) {
									...
									if ('started' === isset($field['group']) && $field['group']) {
										$is_group_item = true;
									}
