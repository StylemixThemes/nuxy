...
<wpcfto_image :fields="<?php echo esc_attr( $field ); ?>"
	...
	:placeholder_text="'<?php echo esc_attr__( 'Image URL', 'nuxy' ); ?>'"
	:upload_text="'<?php echo esc_attr__( 'Upload', 'nuxy' ); ?>'"
	:replace_text="'<?php echo esc_attr__( 'Replace', 'nuxy' ); ?>'"
	:remove_text="'<?php echo esc_attr__( 'Remove', 'nuxy' ); ?>'"
