                ...
                methods: {
                    ...
                    changeTab: function (tab) {
                        ...
                        if ($section.closest('.wpcfto-nav').hasClass('has-submenu')) {
                            ...
                            if ( submenuParam !== null && submenuParam !== undefined && submenuParam !== '' ) {
                                var navSubmenu = $section.closest('.wpcfto-nav').find(`.wpcfto-submenus [data-submenu=${tab}_${submenuParam}]`);
                                $submenu = navSubmenu && navSubmenu.length > 0 ? navSubmenu : $submenu;
                            } 
