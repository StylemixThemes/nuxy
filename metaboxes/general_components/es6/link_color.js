Vue.component('wpcfto_link_color', {
	...
	created: function () {
		...
		this.link = {
			regular: {
				input_value:
					typeof this.field_value.regular !== 'undefined'
						? this.field_value.regular
						: '',
				value:
					typeof this.field_value.regular !== 'undefined'
						? this.field_value.regular
			...
			hover: {
				input_value:
					typeof this.field_value.hover !== 'undefined'
						? this.field_value.hover
						: '',
				value:
					typeof this.field_value.hover !== 'undefined'
						? this.field_value.hover
			...
			active: {
				input_value:
					typeof this.field_value.active !== 'undefined'
						? this.field_value.active
						: '',
				value:
					typeof this.field_value.active !== 'undefined'
						? this.field_value.active
			...
			handler: function (link) {
				...
				Object.keys(link).forEach(key => {
					if (link[key].input_value !== this.copy_link[key].input_value) {
						...
						value[key] =
							typeof link[key].value === 'string'
								? link[key].value
								: this.vuecolor_to_string(link[key].value)
